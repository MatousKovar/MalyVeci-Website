...
export const events : Event[] = [
  ...
  // { title: "Motosraz", date: "2026-05-23", location: "Hoštice", description: "Malý Věci nastoupí v 22:00." },
  // { title: "Anděl Music Bar", date: "2026-05-30", location: "Plzeň", poster_location: "/andel.PNG",description: "Naše první velká akce v Plzni! Přijďte nás podpořit a užít si skvělou hudbu v Anděl Music Baru. Kapela začíná v 20:00. Vstupné 170 Kč." },
  ...
  { title: "Motosraz", date: "2026-07-01", location: "Strašice" ,description: "Zahrajeme kolem 19 hod."},
  ...
  { title: "HD Fest", date: "2026-07-18", location: "Horažďovice" ,description: "Opět po roce si zahrajeme na náměstí, tentokrát budeme celou ankci zakončovat. Začínáme v 20 hodin."},
  ...
  { title: "Otevírání fotbalového stadionu", date: "2026-08-22", location: "Horažďovice, Lipky", description: "Podrobnosti brzy..." },
